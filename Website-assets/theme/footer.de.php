				...
				<footer class="footer">
					...
					<div class="footer--inner">
								...
								<div class="row">
									<div class="col-lg-3 col-md-6 col-md-offset-0 col-sm-6 col-sm-offset-0 col-xs-10 col-xs-offset-1">
										<div class="footer_main--column">
											<strong class="footer_main--column_title">Über uns</strong>
											<div class="footer_about">
												<p class="footer_about--text">
													SwingFish ist ein community-basierendes Projekt, von Trader, für Trader, mit dem ziel, die zinanzielle unabhaengigkeit schnell und ohne den üblichen kosten (Zeit und Geld).
												</p>
												<p class="footer_about--text">
													Zusäzlich, durch die Gemeinschaft, ist es möglich groessere erfolge zu verbuchen, durch austausch in vergleich von strategischen zielen, was zur vertreuung von strategie und zur erhoehung der zuwächse führt.
												</p>
											</div>
										</div>
									</div>
									<div class="col-lg-3 col-md-6 col-md-offset-0 col-sm-6 col-sm-offset-0 col-xs-10 col-xs-offset-1">
										<div class="footer_main--column">
											<strong class="footer_main--column_title">Letzter Blog (in English)</strong>
											<ul class="footer_navigation"><?
												...
												<li class="footer_navigation--item"><a href="<?=URL?>blog/" class="footer_navigation--link">Alle Posts</a></li>
											</ul>
										</div>
									</div>
									...
									<div class="col-lg-3 col-md-6 col-md-offset-0 col-sm-6 col-sm-offset-0 col-xs-10 col-xs-offset-1">
										<div class="footer_main--column">
											<strong class="footer_main--column_title">Mehr Links</strong>
											<ul class="footer_navigation">
						<li class="footer_navigation--item"><a href="<?=URL?>lib/ib/icmarkets" target="_blank" class="footer_navigation--link">IC Markets</a></li>
												...
												<li class="footer_navigation--item"><a href="<?=$LINKS['youtube']?>" target="_blank" class="footer_navigation--link">Alle Videos</a></li>
												<li class="footer_navigation--item"><a href="<?=URL?>terms" class="footer_navigation--link">Bedingungen &amp; FAQ</a></li>
											</ul>
										</div>
									</div>
									<div class="col-lg-3 col-md-6 col-md-offset-0 col-sm-6 col-sm-offset-0 col-xs-10 col-xs-offset-1">
										<div class="footer_main--column">
											<strong class="footer_main--column_title">Kontakte</strong>
											<ul class="footer_contact_info">
												<li class="footer_contact_info--item"> <i class="bi_com-phone"></i><span>Telefon  <a href="tel:+6531590589">+65 (31) 59 0589</a></span></li>
								...
								<div class="footer_copyrights--container">
									<div class="row">
										<? include("lib/riskwarning.de.html"); ?>
<div class="col-sm-6 col-xs-12">
										...
										<div class="col-sm-6 col-xs-12">
											<div class="footer_copyrights--item">
												<p class="footer_copyrights--item_copyrights">SwingFish &copy; <?=date("Y")?>. Alle Rechte Vorbehalten. [<acronym title="updated: <?=HumanAgo($Svn['int'])?>"><?=$Svn['revision']?></acronym>|<?=$hl?>.<? if (isset($_SERVER['HTTP_CF_IPCOUNTRY'])) { echo $_SERVER['HTTP_CF_IPCOUNTRY']; } else { echo "no CF"; } ?> | <?=$load?>]</p>
											</div>
										</div>
									</div>
								</div>
	...
	<div id="mobile_sidebar" class="mobile_sidebar">
		...
		<div class="mobile_menu">
			<ul class="menu">
				...
				<li class="menu-item"><a href="<?=URL?>risk-free"><font color="green">RISIKOFREI</font></a></li>
				<li class="menu-item menu-item-has-children">
					<a href="#">TRATEGIEEN</a>
					<ul class="sub-menu">
						<li class="menu-item"><a href="<?=URL?>strategy/solarwave">Solar Wave</a></li>
						...
						<li class="menu-item"><a href="<?=URL?>strategy/ninja">Ninja</a></li>
				...
				<? if ($Youtube['live'] == 'true') { ?><li class="menu-item"><a href="<?=URL?>live"><font color="red">TRADING LIVE!</font></a></li> <? } ?>
				...
				<li class="menu-item"><a href="<?=$wp_draft['link']?>">TAGEBUCH <?
...
?>
				...
				<li class="menu-item"><a href="<?=URL?>contact">Kontakt</a></li>
				<li class="menu-item"><a href="<?=URL?>enfoid-clientlogin">Kunden Login</a></li>
			</ul>
		</div>
		<!-- select language-->
		<div class="select_language -mobile_sidebar">
			<button type="button" class="select_language--opener"><i class="select_language--opener_icon icons8-globe-earth"></i>Sprache</button>
			...
			<?
											if ($Youtube['live'] == 'true') {
												echo '<a href="'.URL.'index.php?go=live" class="button -waikawa_red">Trading Live!!</a>';
													...
													echo '<<a href="'.URL.'youtube" class="button -waikawa_gray">Video Archiv</a>';
												} ?>
		</div>
	</div>
