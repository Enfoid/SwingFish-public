										...
										<div class="header_contacts">
											...
											<div class="header_contacts--item">
												<div class="contact_mini">
													...
													<a href="<?=URL?>backed-funds"><strong>Kapital: $ <?=number_format($Coverstats['totalequity'])?></strong></a>
													<span> <?
													if ($Coverstats['newsize'] > 1000) {
														echo '<a href="'.URL.'risk-free">Verfügbar: <font color="green">$ '.number_format(round($Coverstats['newsize'], -3)).'</font></a>';
													}
													?></span>
												</div>
											</div>
											<div class="header_contacts--item">
												<div class="contact_mini">
													...
													} else {echo "warte auf trade..."; } ?></span>
												</div>
											</div>
										</div>
										<?
...
*/
?>
								<li class="menu-item"><a href="<?=URL?>risk-free"><font color="green"><strong>Risikofrei</strong></font></a></li>
								<li class="menu-item menu-item-has-mega-menu">
									<a href="<?=URL?>strategies">Strategien</a>
									<div class="mega-menu">
										<div class="mega_nav">
											<div class="container">
												<div class="row">
													...
													<div class="col-md-3 col-xs-4">
														<a href="<?=URL?>strategy/mfcrowd" class="mega_nav--item">
															...
															<dl class="mega_nav--item_body">
																...
																<dd>Macht der Gemeinschaft</dd>
															</dl>
														</a>
													</div>
												</div>
											</div>
											<a href="<?=URL?>strategies" class="mega_nav--open_all"><span>Alle Strategien</span></a>
										</div>
									</div>
								</li>
<?
...
<?
if ($Youtube['live'] == 'true') {
	echo '								<li class="menu-item"><a href="'.URL.'live"><font color="red"><strong>LIVE Trade</strong></font>';
...
?>
								<li class="menu-item"><a href="<?=$wp_draft['link']?>">Tagebuch<?
									if ($wp_draft['hasdraft'] == '1') {
										echo '<span class="menu-item-notify" style="background: red;">Neu!</span>';
									}
								?></a></li>
								<li class="menu-item menu-item-has-mega-menu">
...
?>
											...
											<a href="<?=URL?>blog" class="mega_nav--open_all"><span>mehr herausfinden</span></a>
										</div>
									</div>
								</li>
									<li class="menu-item">
									...
									<ul class="sub-menu">
										...
										<li class="menu-item"><a href="<?=URL?>brokers-ctrader">unsre Broker</a></li>
										<li class="menu-item menu-item-has-children">
											<a href="#">Social</a>
											<ul class="sub-menu">
