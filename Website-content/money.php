...
?>	  <div class="row padding-top">
	  ...
	  <div class="row padding-top">
		  ...
		  <div class="col-sm-12" style="width:100%;padding-top:10px;border: 2px solid #1bdb68; margin: 0 auto 30px auto;">
			  ...
			  <a href="https://www.youtube.com/channel/UCqEcEGQ0sG89j7ZhOdgFOyg/join" class="btn btn-default btn-icon-right waves-effect waves-light mr-3">become a Youtube Member<i class="icon-arrow-right"></i></a><a href="https://ko-fi.com/swingfish" class="btn btn-default btn-icon-right waves-effect waves-light mr-3">Support via Ko-Fi<i class="icon-arrow-right"></i></a><a href="https://www.patreon.com/swingfish" class="btn btn-default btn-icon-right waves-effect waves-light mr-3">become a Patreon<i class="icon-arrow-right"></i></a><!-- <a href="https://www.youtube.com/channel/UCqEcEGQ0sG89j7ZhOdgFOyg/join" class="btn btn-default btn-icon-right waves-effect waves-light mr-3">Boost the Discord Server<i class="icon-arrow-right"></i></a> --> <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=paypal@enfoid.com&item_name=SwingFish Community&item_number=Direct Donation&amount=5%2e00&currency_code=SGD" class="btn btn-default btn-icon-right waves-effect waves-light">Donate<i class="icon-arrow-right"></i></a></p>
		  </div>
</p>
		  </div>
      </div><!-- .row -->
