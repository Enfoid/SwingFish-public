      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 space-bottom-2x">
			<div class="embed-responsive embed-responsive-16by9">
                <iframe src="https://www.youtube.com/embed/N9QvoXEMOD4?rel=0&amp;showinfo=0" width="640" height="360"></iframe>
			</div>
		</div><!-- .col-lg-5.col-md-6 -->
        <div class="col-lg-6 col-md-6 space-bottom-2x">
          <div class="shop-meta space-bottom-2x">
             <span>
              <i class="icon-ribbon hidden-md"></i> for cTrader > 3.3
              <span class="badge">App Version <?php echo get_AppVersion($app); ?></span>
            </span>
          </div>
		  <p>allows the <a href="https://www.elgato.com/en/gaming/stream-deck" target="_blank">Elgato Stream Deck</a> to communicate with cTrader.</p>
			  ...
			  <div class="modal fade" id="downloadmd" tabindex="-1" role="dialog">
				  <div class="modal-dialog">
					  ...
					  <div class="modal-content text-center">
						  <h4>Download StreamDeck 4 cTrader</h4>
						  <div class="modal-body">
							  <p>StreamDeck 4 cTrader is not available for public download, its designed for friends and members of the SwingFish Community.</p>
							 </div>
