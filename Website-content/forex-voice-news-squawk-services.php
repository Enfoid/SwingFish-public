      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-5 col-sm-6 mobile-center">
            <h4 class="block-title swingfish">Squawk Services<small>Spoken Market News</small></h4>
          </div>
        </div><!-- .row -->
        <!-- Pricing Table -->
        <div class="pricing-table space-top">
          <table>
            ...
            <tr>
              <td>&nbsp;</td>
              <td>
                <span class="img-icon"><img src="/assets/services/livesquawk/livesquawk_logo_dl.png" alt="livesquawk logo"></span>
                <span class="text-bold">Live Squawk</span>
                <span class="text-gray space-top">accredited financial and economic news</span>
                <a target="_blank" href="https://www.livesquawk.com/?promo=" class="text-sm space-top">Website</a>
              </td>
              <td>
                <span class="img-icon"><img src="/assets/services/ransquawk/ransquawk.jpg" alt="Ransquawk Logo"></span>
                <span class="text-bold">Ransquawk</span>
...
<!--              <td>
              ...
              <td>
                ...
                <span class="text-gray space-top">free news and financial content</span>
                <a target="_blank" href="https://www.financialjuice.com" class="text-sm space-top">Website</a>
              </td>
              <td>
                <span class="img-icon"><img src="/assets/services/talkingforex/talking-forex-logo.jpg" alt="Talking Forex Logo"></span>
                <span class="text-bold">Talking Forex</span>
                <span class="text-gray space-top">rapid audio information</span>
                <a target="_blank" href="https://talking-forex.com/" class="text-sm space-top">Website</a>
              </td>
            </tr>
            <tr>
